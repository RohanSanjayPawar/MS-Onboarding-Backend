...
public class OnboardeeQueries {
	...
	public static final String UPDATE_ONBOARDEE = "UPDATE ONBOARDEE o SET o.FIRST_NAME=?, o.LAST_NAME=?, o.WEB_LOGIN_ID=?, o.STATUS=?, o.BG_STATUS=?, o.ETA_FOR_ONBOARDING=? WHERE o.UID=?";
	
	/** The Constant ADD_ONBOARDEE. */
	public static final String ADD_ONBOARDEE = "INSERT INTO ONBOARDEE(UID, FIRST_NAME, LAST_NAME, WEB_LOGIN_ID, SKILLS, DEMAND, STATUS, BG_STATUS, ETA_FOR_ONBOARDING) VALUES(?, ?, ?, ?, ?, ?, 'Not Started', 'Not Started', 10)";
